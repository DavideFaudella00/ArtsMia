...
public class FXMLController {
	...
	void doAnalizzaOggetti(ActionEvent event) {
		...
		txtResult.appendText("Numero vertici: " + model.nArchi());
	}
	...
	void doCalcolaComponenteConnessa(ActionEvent event) {
		...
		int objId;
		try {
			objId = Integer.parseInt(txtObjectId.getText());
		} catch (NumberFormatException e) {
			txtResult.appendText("INSERISCI NUMERO");
			return;
		}
		ArtObject vertice = this.model.getObject(objId);
	...
	void initialize() {
		...
		assert btnCalcolaComponenteConnessa != null
				: "fx:id=\"btnCalcolaComponenteConnessa\" was not injected: check your FXML file 'Scene.fxml'.";
		assert btnCercaOggetti != null
				: "fx:id=\"btnCercaOggetti\" was not injected: check your FXML file 'Scene.fxml'.";
		assert btnAnalizzaOggetti != null
				: "fx:id=\"btnAnalizzaOggetti\" was not injected: check your FXML file 'Scene.fxml'.";
